...
<p align="center">
<img src="../../assets/01-landscape/agent-comparison.svg" alt="三种AI应用形态对比" width="90%"/>
<br/>
<em>Chatbot 回答问题 · Workflow 执行流程 · Agent 解决问题</em>
</p>
...
<p align="center">
<img src="../../assets/01-landscape/agent-loop.svg" alt="Agent 循环：感知→推理→行动→反馈" width="85%"/>
<br/>
<em>Agent 循环：感知 → 推理 → 行动 → 反馈，直到任务完成</em>
</p>
