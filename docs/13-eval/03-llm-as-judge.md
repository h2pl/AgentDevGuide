...
<p align="center">
  <img src="../../assets/13-eval/judge-modes.svg" alt="三种评分模式" width="95%"/>
</p>
...
<p align="center">
  <img src="../../assets/13-eval/llm-judge-scoring-flow.svg" alt="LLM-as-Judge 评分流程与偏差控制：从输入到结构化输出的完整链路" width="95%"/>
</p>
