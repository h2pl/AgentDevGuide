...
| [06 系统提示词](./06-system-prompt-engineering/README.md) | 提示词组装与缓存冻结 | Ch04 | systemPrompt.ts + prompts |
| [07 上下文工程](./07-context-engineering/README.md) | 五层压缩管线 | Ch07 | services/compact/ (2960行) |
