...
| # | 文章 | 内容 |
|---|------|------|
| 01 | [协议全景](./01-protocol-landscape.md) | 协议分层模型、MCP / A2A / ACP / ANP / AG-UI / OAP 全局格局、2026 行业共识 |
| 02 | [MCP 深入](./02-mcp-in-depth.md) | 协议治理与版本化、Gateway 企业部署、MCP vs Function Calling 的关系、回链第 04 章实现细节 |
