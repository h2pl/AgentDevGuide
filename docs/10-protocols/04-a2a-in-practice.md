...
<p align="center">
  <img src="../../assets/10-protocols/a2a-interaction-modes.svg" alt="A2A 三种交互模式：同步/流式/异步" width="90%"/>
</p>
...
<p align="center">
  <img src="../../assets/10-protocols/a2a-multi-agent-system.svg" alt="多 Agent 协作系统架构：主 Agent 分发任务给搜索和分析 Agent" width="90%"/>
</p>
