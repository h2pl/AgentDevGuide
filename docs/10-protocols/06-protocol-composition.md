...
<p align="center">
  <img src="../../assets/10-protocols/protocol-evolution-path.svg" alt="协议采纳不应超前于业务阶段" width="90%"/>
</p>
...
<p align="center">
  <img src="../../assets/10-protocols/protocol-decision-tree.svg" alt="协议选型决策树" width="90%"/>
</p>
...
> 下一章 [11 — 多 Agent](../11-multi-agent/README.md)，进入多 Agent 协作的世界——不是通过协议连接外部 Agent，而是在同一系统内设计多个 Agent 的协作架构。
