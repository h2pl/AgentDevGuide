...
> 掌握了上下文工程，你已经能让 Agent 的记忆精准、上下文精简、成本可控。这些能力加上工具调用和 Agent 循环，你已经具备了构建生产级 Agent 的完整技能。接下来进入 [08 — 知识检索（RAG）](../08-rag-pipeline/README.md)，学习如何让 Agent 基于外部知识库回答问题。
