...
在 [01 — LLM 基础](../02-llm-basics/README.md) 建立认知之后，这一章带你从选模型到跑通代码：先建立全局认知，认识 API 关键参数，再立刻动手调用 API 获得第一手体验，然后深入理解模型变体、推理模型、本地部署等高级话题。
...
> 学完本章后，请继续阅读 [03 — Prompt 工程](../04-prompt-engineering/README.md)，学习如何通过文字精确控制模型行为。
