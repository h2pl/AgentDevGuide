...
![16+ 章节](https://img.shields.io/badge/16%2B%20%E7%AB%A0%E8%8A%82-8A2BE2)
![98 文章](https://img.shields.io/badge/98%20%E7%AF%87%E6%96%87%E7%AB%A0-00BFFF)
...
| 🔬 **进阶扩展** | [多模态 AI 系统化讲解](./docs/advanced/README.md)（4 章：基础→理解→生成→推理与工程） |
...
核心 16 章之后的进阶内容，系统化讲解多模态 AI——从全景认知到工程落地。

- [01 多模态基础](./docs/advanced/01-multimodal-fundamentals/README.md) — 全景认知与核心机制（理解 vs 生成两条技术路线）
- [02 多模态理解](./docs/advanced/02-multimodal-understanding/README.md) — 视觉理解与语音音频
- [03 多模态生成](./docs/advanced/03-multimodal-generation/README.md) — 图像与视频生成（扩散模型、API、Prompt 策略）
- [04 多模态推理与工程](./docs/advanced/04-multimodal-reasoning/README.md) — 跨模态推理、评估、成本、安全、上线 checklist

> 完整导航：[进阶扩展栏目](./docs/advanced/README.md)
